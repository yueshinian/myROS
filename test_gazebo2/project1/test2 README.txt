...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=test2&box=128.319817,45.129826,128.217953,45.057961
...
-----------
  ...
  * test2 Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * test2 Height Map (SRTM3 v4.1).png
  ...
  * test2 Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 192m (actual) is equal to 40m in
