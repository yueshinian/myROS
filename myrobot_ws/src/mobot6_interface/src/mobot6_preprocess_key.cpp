...
{
public:
    void callback(const mobot6_interface::Keyboard::ConstPtr & message)
    {
        mCrtMsg = *message;
        mNewMsg = true;
    }
    ...
    const mobot6_interface::Keyboard& fetchMsg()
    {
        mNewMsg = false;
        return mCrtMsg;
    }
...
protected:
    mobot6_interface::Keyboard mCrtMsg;
    bool mNewMsg;
};
...
int main(int argc, char **argv)
{
    ...
    mobot6_interface::Keyboard  data_input;
    ...
    state_input.subKeyboardInput =
            Node_Handle.subscribe<mobot6_interface::Keyboard>(
